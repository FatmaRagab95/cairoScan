	...
	new Vue({
		...
		methods: {
			offDays: function (impId) {
				...
				if (impId !== "") {
					$.ajax({
						type: "POST", 
						url: "../Hr_Portal/Vacation_Request.aspx/getDaysOffData",
			...
			SubmitVacationRequest: function () {
				...
				if(that.impId === "") {
					...
					// checking balance
						...
						$.ajax({
							type: "POST", 
							url: "../Hr_Portal/Vacation_Request.aspx/checkBalance",
									...
									function decrease (total) {
										...
										if (type == "Casual") {
											if (DaysNum > casualBalance || DaysNum > total) {
												...
												$.ajax({
													type: "POST", 
													url: "../Hr_Portal/Vacation_Request.aspx/getPeriodsData",
													data:JSON.stringify({"detail": {"Emp_id": ObjectD.Requester_id}}),
													contentType: "application/json; charset=utf-8",
													dataType: "json",
													success: function (data) {
					...
					function sending () {
						...
						$.ajax({  
							type: "POST",
							url: "../Hr_Portal/Vacation_Request.aspx/NewHR_Vacations_Requests",
							...
							success: function () {
								function ajaxFunc () {
									if (ObjectD.Vacation_Type_id == 103) {
										...
										return $.ajax({  
											type: "POST",
											url: "../Hr_Portal/Vacation_Request.aspx/updateOffDays",
								...
								$.when(ajaxFunc()).done(function (a) {
									for (let i = 0; i < that.multiDates.length; i++) {
										$.ajax({  
											type: "POST",
											url: "../Hr_Portal/Vacation_Request.aspx/NewHR_Vacations_Days",
		...
		watch: {
			impId: function () {
				...
				this.NewHR_Vacations_Requests.Requester_name = this.impName;
		...
		created: function () {
			...
			$.ajax({
				type: "POST", 
				url: "../Hr_Portal/Vacation_Request.aspx/getadminusersData",
				contentType: "application/json; charset=utf-8",
				dataType: "json",
				success: function (data) {
			...
			$.ajax({
				type: "POST", 
				url: "../Hr_Portal/Vacation_Request.aspx/gettypesData",
				contentType: "application/json; charset=utf-8",
				dataType: "json",
				success: function (data) {
